...
import com.fyp.timed.databinding.ActivityAddNewReminderBinding
import com.fyp.timed.databinding.DialogMarkerBinding
import com.fyp.timed.databinding.DialogMobileNoBinding
...
class AddNewReminder : AppCompatActivity(), View.OnClickListener {
    ...
    private fun onSaveButtonClicked() {
        ...
        /*
        * convert selected date time to miles
        * */
    ...
    private fun saveReminder(
        ...
        lifecycleScope.launch {
            ...
            this.coroutineContext.let {
                ...
                if (long > 0) {
                    onSchedulAlarm(millies, reminderTitle, selectedRepeat,alarmId,selectedReportAs)
                    Log.d(tag, "saveReminder: " + millies)
